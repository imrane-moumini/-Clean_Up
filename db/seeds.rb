...
booking3 = Booking.create!(user_id: user_imrane.id, slot_id: slot3.id, start_time: start, end_time: start + 1.hours, status: true, task_accomplished: false, booking_price_cents: cleaner_jean.user_price_cents)
