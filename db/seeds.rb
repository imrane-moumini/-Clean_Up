...
cleaner_paul = User.create!(first_name: "Paul", last_name: "Dufour", email: "paul.duffour@gmail.com", password: "password5", address: "8 rue Bel Air 13006 Marseille", degree: "CAP agent de propreté et d'hygiène", years_of_experience: 6, description: "Bonjour je m'appelle Paul, j'ai été agent d'entretien chez des particuliers pendant près de 6 ans. Très minitieux, je m'occuperais bien de votre intérieur.", number_of_reviews: 12, user_price: 10, cleaner:true)
...
cleaner_jean = User.create!(first_name: "Jean", last_name: "Loup", email: "jean.loup@gmail.com", password: "password6", address: "4 rue du Village 13006 Marseille", degree: "BEP en maintenance et hygiène des locaux", years_of_experience: 2, description: "Bonjour je m'appelle Jean, je suis à votre disposition, compétent et motivé! Je serais prendre soin de votre intérieur comme il se doit ! Vous pouvez me faire confiance. Le contact avec les clients et une des choses que je préfère.", number_of_reviews: 9, user_price: 10, cleaner:true)
...
review3 = Review.create!(content: "Encore un peu de poussière mais le gros du travail a été fait merci #{booking3.slot.user.first_name}", rating: 3, booking_id: booking3.id)
